// This header file defines all the constants, data types, and function interfaces used throughout
// the HoG accelerator design, including image dimensions, cell sizes, fixed-point types, and the
// main hog_compute kernel signature.
