// This file implements the host-side test harness that runs the HoG feature extraction algorithm
// on both software (ARM CPU) and hardware (FPGA). It compares the outputs, measures performance,
// and reports speedup metrics between the two implementations.
